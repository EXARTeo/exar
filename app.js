...
`;
    ...
    const FILESYSTEM = {
        ...
        '/home': { type: 'dir', children: ['cv', 'social'] },
        '/home/cv': { type: 'dir', children: ['Exarchos_Theodoros_CV.pdf'] },
        '/home/cv/Exarchos_Theodoros_CV.pdf': { type: 'file', action: 'download_cv' },
        '/home/social': { type: 'dir', children: ['social.txt'] },
        '/home/social/social.txt': { type: 'file', content: 'social' },
        '/timeline': { type: 'dir', children: ['work', 'education'] },
        ...
        '/featured': { type: 'dir', children: ['nfs', 'neural-lsh'] },
